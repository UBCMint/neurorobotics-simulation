...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            minimum = min(minimum, np.min(smooth_band_powers[Band.Theta]))
            maximum = max(maximum, np.max(smooth_band_powers[Band.Theta]))
            print('Theta smooth_band_powers: ', smooth_band_powers[Band.Theta])
            # print('current max: ', maximum)
            # print('current min: ', minimum)
            
            past_powers.append(smooth_band_powers[Band.Theta])
        ...
        print('Closing!')
        plt.plot(len(past_powers), past_powers)
        plt.show()
